// All icon components consolidated into a single file
...
export const ThreeDotsIcon = ({ className = "w-5 h-5" }) => (
...
export const CheckmarkIcon = ({ className = "w-4 h-4", strokeWidth = "2.5" }) => (
...
export const ShuffleIcon = ({ className = "w-5 h-5" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
