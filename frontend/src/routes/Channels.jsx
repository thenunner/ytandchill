...
export default function Channels() {
  ...
  const [menuOpen, setMenuOpen] = useState(null); // Track which channel's menu is open
    ...
    <div className="space-y-6 animate-fade-in">
      <div className="sticky top-[100px] z-40 bg-dark-primary/95 backdrop-blur-lg -mx-4 px-4 py-4 mb-4">
        <div className="flex items-center gap-4">
          <h2 className="text-2xl font-bold text-text-primary">Channels</h2>
          <button
          ...
          <input
            ...
            className="search-input w-[200px] h-8 py-1 px-3 text-sm"
          />
          ...
          <div className="relative" ref={sortMenuRef}>
            ...
            {/* Sort Dropdown Menu */}
            {showSortMenu && (
              <div className="absolute right-0 mt-2 w-56 bg-dark-secondary border border-dark-border rounded-lg shadow-xl py-2 z-50">
